...
(cl:defmethod cl:initialize-instance :after ((m <control_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name copley-msg:<control_msg> is deprecated: use copley-msg:control_msg instead.")))
...
(cl:defmethod motor_0-val ((m <control_msg>))
...
(cl:defmethod motor_1-val ((m <control_msg>))
...
(cl:defmethod motor_2-val ((m <control_msg>))
...
(cl:defmethod motor_3-val ((m <control_msg>))
...
(cl:defmethod motor_4-val ((m <control_msg>))
...
(cl:defmethod motor_5-val ((m <control_msg>))
