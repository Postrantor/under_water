...
# ==================================================
    ...
    # State Space Equation
        ...
        # [issue]:
        # 应该是这里出现了问题，不应该是简单的`*dt`，每次的dt都很小呀
        # 如果积分的话，应该加上之前的所有值
        self.varphi = dot_varphi * dt + self.varphi
        self.dot_varphi = ddot_varphi * dt + self.dot_varphi
...
# ==================================================
    ...
    # dt = t_cur - t_pre
        ...
        # print("impedance['dt']={}".format(impedance['dt'])) # 8.4162e-05
        if impedance['dt'] == 0:
            return 0
    # calc control value
