...
'''md
    [20210822]: temp
        与仿真程序相对应，当前去除正逆运动学模型，直接驱动电机转动
        1. 去除正逆运动学，为了避免数学计算的时候出错(这个问题之后也要单独解决)
        2. 对tau_e给变化的数值，观察在阻抗控制的作用下电机的实际运动的速度、位置是否也会变化，而且是跟随力的变化而变化
    [20210817]:
...
# ==================================================
    ...
    # State Space Equation
        ...
        # print("varphi={}, dot_varphi={}, ddot_varphi={}".format(varphi, dot_varphi, ddot_varphi))
        # print("dt={}".format(dt))
