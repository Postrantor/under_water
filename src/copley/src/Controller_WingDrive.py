...
# %% Constant
# NodeInfo
NodeName = 'Controller_WingDrive'
SubscriberNameCmdSwitch = 'cmd/switch'
PublisherNameControlSwitch = 'control/wing'
PublisherNameFeedbackSwitch = 'feedback/wing'
# Serial
# 负极限值
...
class ControlsToMotors(DebugSteam, BagPathClass):
    ...
    def inits_Motor(self):
        ...
        # 减速比：23:1
        # 编码器：1000
        self.Motor_Wing = Motor.MotorClass(PortID=PortID_UCR, NodeID=0, Mode='Position',  # PortID_Wing
