...
class Port():
    ...
    def inits_AlgKalmanFilter(self):
        ...
        self.kf_current = SingleStateKalmanFilter(x, P, A, B, C, Q, R)
    ...
    # 电流模式
        ...
        # self.RxD('g r0x0c\r') # Actual Current, Q axis of rotor space. Units: 0.01 A.
    # 速度模式
        # self.RxD('1 s r0x24 11\r')
        # self.RxD('1 s r0x36 100000\r')
        # self.RxD('1 s r0x37 100000\r')
        # self.RxD('1 s r0x2f 2004858\r') # 58709 # 15333 # 15333 # 1rpm # 6048585/5511281
        # self.RxD('g r0x18\r') # Actual Velocity. Units: 0.1 encoder counts/s.
    ...
    # 位置模式
        ...
        # self.RxD('s r0xca 512000\r') # Trajectory Generator Position Command(0xca). Units: Counts. 1024*4*86=352256/1000*4*23=92000/1000*4*128=512000
        #    # 117555 = 1000*4*23 * (46/360*10)对于当前右侧，正向是推出
        #    # 27662正值是伸出
        # self.RxD('s r0xcb 548585\r') # Trajectory Maximum Velocity. Units: 0.1 counts/s. # 8330*1000*4*10/60=5553333
        # self.RxD('s r0xcc 100000\r') # Trajectory Maximum Acceleration. Units: 10 counts/s2. # 1000000差不多就是极限了
        # self.RxD('s r0xcd 100000\r') # Trajectory Maximum Deceleration. Units: 10 counts/s2.
    ...
    # Encoder
        ...
        # self.RxD('0 g r0x32\r') # Motor position. Units: counts. 
        # self.RxD('1 g r0x32\r') # Motor position. Units: counts. 
